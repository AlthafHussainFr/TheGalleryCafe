...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO srilankan_meal (meal_name, meal_price, about, meal_picture) VALUES ('$meal_name', '$meal_price', '$about', '$meal_picture')";
...
<head>
    <meta charset="UTF-8">
    <title>Add Sri Lankan Meal</title>
    <style>
        body {
...
<body>
    <div class="container">
        <div class="image-container">
            <img src="sign.jpg" alt="Meal Image">
        </div>
        <div class="form-container">
            <h2>Add Sri Lankan Meal</h2>
