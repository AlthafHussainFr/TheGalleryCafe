...
$sql = "SELECT id, meal_name, meal_price, about, meal_picture FROM italian_meal";
...
<body>
    ...
    <div class="menu">
        <nav>
          ...
          <li><a href="msl.php">Srilankan Meals</a></li>
          <li><a href="mit.php">Italian Meals</a></li>
          <li><a href="mcn.php">Chinese Meals</a></li>
          <li><a href="mbv.php">Bevarages</a></li>
    ...
    <div class="container">
        ...
        <div class="meal-grid">
            ...
            $sql = "SELECT id, meal_name, meal_price, about, meal_picture FROM italian_meal WHERE meal_name LIKE '%$search%'";
            $result = $conn->query($sql);
