...
$sql = "SELECT id, meal_name, meal_price, about, meal_picture FROM bevarages";
...
<body>
    ...
    <div class="container">
        ...
        <div class="meal-grid">
            ...
            $sql = "SELECT id, meal_name, meal_price, about, meal_picture FROM bevarages WHERE meal_name LIKE '%$search%'";
            $result = $conn->query($sql);
