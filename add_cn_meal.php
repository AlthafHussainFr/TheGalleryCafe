...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty($meal_name) || empty($meal_price) || empty($about)) {
        ...
        if ($meal_picture) {
            ...
            $sql = "INSERT INTO chinese_meal (meal_name, meal_price, about, meal_picture) VALUES ('$meal_name', '$meal_price', '$about', '$meal_picture')";
