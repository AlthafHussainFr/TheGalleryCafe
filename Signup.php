...
.input-field {
    max-width: 380px;
    width: 100%;
    background-color: white; /* Dark input field background color */
    margin: 10px 0;
    height: 55px;
...
.btn {
    width: 150px;
    background-color: #825302; /* Orange button color */
    border: none;
    outline: none;
    height: 49px;
    border-radius: 4px;
...
.btn:hover {
    background-color: brown; /* Lighter orange color on hover */
}
